...
if(NOT "/home/pi/21_hf271/PI_main/build/devel/include;/home/pi/21_hf271/PI_main/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(compressed_depth_image_transport_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/21_hf271/PI_main/build/devel/include;/home/pi/21_hf271/PI_main/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_depth_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/21_hf271/PI_main/src/image_transport_plugins/compressed_depth_image_transport/${idir}'.  ${_report}")
    endif()
