...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_simulation_scene_SOURCE_PREFIX /home/kyung/21_hf271/socket_comm/src/ros-sharp/ROS/gazebo_simulation_scene)
  set(gazebo_simulation_scene_DEVEL_PREFIX /home/kyung/21_hf271/socket_comm/devel)
  ...
  set(gazebo_simulation_scene_INSTALL_PREFIX /home/kyung/21_hf271/socket_comm/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_simulation_scene' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kyung/21_hf271/socket_comm/src/ros-sharp/ROS/gazebo_simulation_scene/${idir}'.  ${_report}")
    endif()
