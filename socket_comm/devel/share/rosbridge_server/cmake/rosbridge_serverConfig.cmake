...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/kyung/21_hf271/socket_comm/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/kyung/21_hf271/socket_comm/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_server/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rosbridge_server_EXPORTED_TARGETS ${${rosbridge_server_dep}_EXPORTED_TARGETS})
endforeach()
