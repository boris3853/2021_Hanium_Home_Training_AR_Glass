...
(cl:in-package json_publisher-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <KeypointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeypointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name json_publisher-msg:<KeypointArray> is deprecated: use json_publisher-msg:KeypointArray instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <KeypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader json_publisher-msg:x-val is deprecated.  Use json_publisher-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <KeypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader json_publisher-msg:y-val is deprecated.  Use json_publisher-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'prob-val :lambda-list '(m))
(cl:defmethod prob-val ((m <KeypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader json_publisher-msg:prob-val is deprecated.  Use json_publisher-msg:prob instead.")
  (prob m))

(cl:ensure-generic-function 'KeyTrue-val :lambda-list '(m))
(cl:defmethod KeyTrue-val ((m <KeypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader json_publisher-msg:KeyTrue-val is deprecated.  Use json_publisher-msg:KeyTrue instead.")
  (KeyTrue m))

(cl:ensure-generic-function 'type_ex-val :lambda-list '(m))
(cl:defmethod type_ex-val ((m <KeypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader json_publisher-msg:type_ex-val is deprecated.  Use json_publisher-msg:type_ex instead.")
  (type_ex m))
