...
if("TRUE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosapi)
  set(rosapi_DEVEL_PREFIX /home/kyung/21_hf271/socket_comm/devel)
  set(rosapi_INSTALL_PREFIX "")
  set(rosapi_PREFIX ${rosapi_DEVEL_PREFIX})
else()
  set(rosapi_SOURCE_PREFIX "")
  set(rosapi_DEVEL_PREFIX "")
  set(rosapi_INSTALL_PREFIX /home/kyung/21_hf271/socket_comm/install)
...
if(NOT "/home/kyung/21_hf271/socket_comm/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosapi/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rosapi_EXPORTED_TARGETS ${${rosapi_dep}_EXPORTED_TARGETS})
endforeach()
