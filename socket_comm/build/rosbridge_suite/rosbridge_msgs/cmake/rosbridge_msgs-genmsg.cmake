...
set(MSG_I_FLAGS "-Irosbridge_msgs:/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_msgs/msg/ConnectedClient.msg" NAME_WE)
add_custom_target(_rosbridge_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosbridge_msgs" "/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_msgs/msg/ConnectedClient.msg" ""
)

get_filename_component(_filename "/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_msgs/msg/ConnectedClients.msg" NAME_WE)
add_custom_target(_rosbridge_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosbridge_msgs" "/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_msgs/msg/ConnectedClients.msg" "rosbridge_msgs/ConnectedClient"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosbridge_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosbridge_msgs\")")
  # install generated code
  install(
