...
echo_and_run cd "/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_library"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/kyung/21_hf271/socket_comm/src/rosbridge_suite/rosbridge_library/setup.py" \
     \
    build --build-base "/home/kyung/21_hf271/socket_comm/build/rosbridge_suite/rosbridge_library" \
    install \
    --root="${DESTDIR-/}" \
