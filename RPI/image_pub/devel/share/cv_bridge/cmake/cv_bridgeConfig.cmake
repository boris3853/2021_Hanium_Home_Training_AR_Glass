...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/pi/21_hf271/RPI/image_pub/src/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/pi/21_hf271/RPI/image_pub/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/pi/21_hf271/RPI/image_pub/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/21_hf271/RPI/image_pub/src/cv_bridge/${idir}'.  ${_report}")
    endif()
