...
if("TRUE" STREQUAL "TRUE")
  set(compressed_depth_image_transport_SOURCE_PREFIX /home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_depth_image_transport)
  set(compressed_depth_image_transport_DEVEL_PREFIX /home/kyung/21_hf271/image_transport/devel)
  ...
  set(compressed_depth_image_transport_INSTALL_PREFIX /home/kyung/21_hf271/image_transport/install)
...
if(NOT "/home/kyung/21_hf271/image_transport/devel/include;/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/include/opencv4 " STREQUAL " ")
  set(compressed_depth_image_transport_INCLUDE_DIRS "")
  set(_include_dirs "/home/kyung/21_hf271/image_transport/devel/include;/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_depth_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_depth_image_transport/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(compressed_depth_image_transport_EXPORTED_TARGETS ${${compressed_depth_image_transport_dep}_EXPORTED_TARGETS})
endforeach()
