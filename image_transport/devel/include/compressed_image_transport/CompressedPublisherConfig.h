...
namespace compressed_image_transport
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CompressedPublisherConfig &config, const CompressedPublisherConfig &max, const CompressedPublisherConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CompressedPublisherConfig &config1, const CompressedPublisherConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CompressedPublisherConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CompressedPublisherConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CompressedPublisherConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CompressedPublisherConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CompressedPublisherConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CompressedPublisherConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CompressedPublisherConfig::AbstractParamDescriptionConstPtr(new CompressedPublisherConfig::ParamDescription<std::string>("format", "str", 0, "Compression format", "{'enum': [{'name': 'jpeg', 'type': 'str', 'value': 'jpeg', 'srcline': 9, 'srcfile': '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'description': 'JPEG lossy compression', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'png', 'type': 'str', 'value': 'png', 'srcline': 10, 'srcfile': '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'description': 'PNG lossless compression', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Enum to set the compression format'}", &CompressedPublisherConfig::format)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CompressedPublisherConfig::AbstractParamDescriptionConstPtr(new CompressedPublisherConfig::ParamDescription<std::string>("format", "str", 0, "Compression format", "{'enum': [{'name': 'jpeg', 'type': 'str', 'value': 'jpeg', 'srcline': 9, 'srcfile': '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'description': 'JPEG lossy compression', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'png', 'type': 'str', 'value': 'png', 'srcline': 10, 'srcfile': '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'description': 'PNG lossless compression', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Enum to set the compression format'}", &CompressedPublisherConfig::format)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg"
      const char * const CompressedPublisher_jpeg = "jpeg";
//#line 10 "/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg"
