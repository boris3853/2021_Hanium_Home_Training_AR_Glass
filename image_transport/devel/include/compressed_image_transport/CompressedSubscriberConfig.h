...
namespace compressed_image_transport
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CompressedSubscriberConfig &config, const CompressedSubscriberConfig &max, const CompressedSubscriberConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CompressedSubscriberConfig &config1, const CompressedSubscriberConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CompressedSubscriberConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CompressedSubscriberConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CompressedSubscriberConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CompressedSubscriberConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CompressedSubscriberConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CompressedSubscriberConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CompressedSubscriberConfig::AbstractParamDescriptionConstPtr(new CompressedSubscriberConfig::ParamDescription<std::string>("mode", "str", 0, "Color Mode", "{'enum': [{'name': 'unchanged', 'type': 'str', 'value': 'unchanged', 'srcline': 9, 'srcfile': '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedSubscriber.cfg', 'description': 'keep image encoding', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'gray', 'type': 'str', 'value': 'gray', 'srcline': 10, 'srcfile': '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedSubscriber.cfg', 'description': 'decode to gray', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'color', 'type': 'str', 'value': 'color', 'srcline': 11, 'srcfile': '/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedSubscriber.cfg', 'description': 'decode to color', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Enum to set the decompression color mode'}", &CompressedSubscriberConfig::mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedSubscriber.cfg"
      const char * const CompressedSubscriber_unchanged = "unchanged";
//#line 10 "/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedSubscriber.cfg"
      const char * const CompressedSubscriber_gray = "gray";
//#line 11 "/home/kyung/21_hf271/image_transport/src/image_transport_plugins/compressed_image_transport/cfg/CompressedSubscriber.cfg"
