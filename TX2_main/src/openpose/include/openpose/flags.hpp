...
DEFINE_string(camera_resolution,        "352x288",        "Set the camera resolution (either `--camera` or `--flir_camera`). `-1x-1` will use the"
...
DEFINE_string(net_resolution,           "128x128",       "Multiples of 16. If it is increased, the accuracy potentially increases. If it is"
...
DEFINE_double(render_threshold,         0.005,           "Only estimated keypoints whose score confidences are higher than this threshold will be"
