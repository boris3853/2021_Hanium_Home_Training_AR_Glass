...
echo_and_run cd "/home/nvidia/21_hf271/TX2_main/src/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/nvidia/21_hf271/TX2_main/build/cv_bridge \
    build --build-base "/home/nvidia/21_hf271/TX2_main/build/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
