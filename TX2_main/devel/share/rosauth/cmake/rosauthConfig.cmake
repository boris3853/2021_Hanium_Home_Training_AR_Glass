...
if("TRUE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /home/nvidia/21_hf271/TX2_main/src/rosauth)
  set(rosauth_DEVEL_PREFIX /home/nvidia/21_hf271/TX2_main/devel)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /home/nvidia/21_hf271/TX2_main/install)
...
if(NOT "/home/nvidia/21_hf271/TX2_main/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/21_hf271/TX2_main/src/rosauth/${idir}'.  ${_report}")
    endif()
