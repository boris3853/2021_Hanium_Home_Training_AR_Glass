...
set(MSG_I_FLAGS "-Iimage_transport_tutorial:/home/kyung/image_transport_ws/src/image_transport_tutorial/msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kyung/image_transport_ws/src/image_transport_tutorial/msg/ResizedImage.msg" NAME_WE)
add_custom_target(_image_transport_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "image_transport_tutorial" "/home/kyung/image_transport_ws/src/image_transport_tutorial/msg/ResizedImage.msg" "std_msgs/Header:sensor_msgs/Image"
)
...
_generate_msg_cpp(image_transport_tutorial
  "/home/kyung/image_transport_ws/src/image_transport_tutorial/msg/ResizedImage.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/image_transport_tutorial)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/image_transport_tutorial\")")
  # install generated code
  install(
