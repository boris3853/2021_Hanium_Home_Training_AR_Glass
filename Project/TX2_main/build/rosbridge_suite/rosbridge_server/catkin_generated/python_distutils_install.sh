...
echo_and_run cd "/home/nvidia/21_hf271/TX2_main/src/rosbridge_suite/rosbridge_server"
...
echo_and_run /usr/bin/env \
    ...
    "/home/nvidia/21_hf271/TX2_main/src/rosbridge_suite/rosbridge_server/setup.py" \
     \
    build --build-base "/home/nvidia/21_hf271/TX2_main/build/rosbridge_suite/rosbridge_server" \
    install \
    --root="${DESTDIR-/}" \
