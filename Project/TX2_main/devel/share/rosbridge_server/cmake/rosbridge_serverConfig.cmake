...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/nvidia/21_hf271/TX2_main/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/nvidia/21_hf271/TX2_main/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/nvidia/21_hf271/TX2_main/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/21_hf271/TX2_main/src/rosbridge_suite/rosbridge_server/${idir}'.  ${_report}")
    endif()
