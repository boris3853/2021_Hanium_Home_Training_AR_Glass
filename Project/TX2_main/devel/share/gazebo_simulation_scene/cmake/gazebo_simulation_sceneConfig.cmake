...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_simulation_scene' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/21_hf271/TX2_main/src/ros-sharp/ROS/gazebo_simulation_scene/${idir}'.  ${_report}")
    endif()
